      ...
      <div className="p-4 border-t border-slate-200">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors"
            disabled={loading}
          />
          <button
            onClick={onSubmit}
            disabled={loading || !userInput.trim()}
            className="bg-blue-600 text-white p-3 rounded-lg hover:bg-blue-700 disabled:bg-slate-300 disabled:cursor-not-allowed transition-colors"
          >
